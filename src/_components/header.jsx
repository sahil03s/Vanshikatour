            ...
            <div ref={menuRef} className={`${navMenuOpen ? 'max-sm:w-full max-lg:w-64 menu-appear' : 'menu-disappear'} box-border absolute top-16 sm:top-28 right-0 h-fit lg:h-auto  lg:static lg:flex lg:p-8 z-50`}>
                <div className={`flex flex-col lg:flex-row lg:items-center lg:px-4 h-fit max-sm:w-full max-lg:w-64 max-lg:text-white bg-periwinkle lg:bg-white`}>
                    <ul className='list-none flex flex-col lg:items-center lg:flex-row lg:text-center lg:space-x-6'>
                        ...
                        {showBox && (
                            <div className="fixed bg-[#31363F] text-white text-[0.9em] h-auto rounded-xl right-[2%] top-[19%] p-8" ref={boxRef}>
                            {isAuthorized ? (
                                <div>   
                                <div className="text-center">Logged In</div>
                                <div className="text-center">
                                    <MailIcon className="mr-1 mt-2" />
                                    {user}
                                </div>
                                <button type="button" className="bg-white text-black rounded-2xl px-16 py-2 mt-2" onClick={logout}>
                                ...
                                <button
                                    type="button"
                                    className="bg-white text-black rounded-2xl px-16 py-2 mb-2"
                                    onClick={() => {
                                ...
                                <button
                                    type="button"
                                    className="bg-white text-black rounded-2xl px-16 py-2"
                                    onClick={() => {
